...
public class Lexer {
    ...
    static enum TokenType {
        ...
        Keyword_else, Keyword_while, Keyword_print, Keyword_BOOLEAN, Keyword_CHAR,Keyword_INT,  Keyword_FLOAT,  Keyword_putc, LeftParen, RightParen,
    ...
    Lexer(String source) {
        ...
        this.keywords.put("boolean", TokenType.Keyword_BOOLEAN);
    ...
    public static void main(String[] args) {
        ...
        File file = new File("C:/Users/user/Desktop/lexer/input.java");
